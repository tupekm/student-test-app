...
/**
 * Servlet implementation class SudentControllerServlet
 */
@WebServlet("/SudentControllerServlet")
public class SudentControllerServlet extends HttpServlet {
	...
	private void deleteStudent(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//send them back to student page
		listStudents(request, response);
